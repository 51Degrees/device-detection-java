 ...
 */
	...
	@Override
	public AspectPropertyValue<Boolean> getIsMobile() { return getAs("ismobile", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsTablet() { return getAs("istablet", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenPixelsWidth() { return getAs("screenpixelswidth", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenPixelsHeight() { return getAs("screenpixelsheight", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasTouchScreen() { return getAs("hastouchscreen", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a physical qwerty keyboard.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasQwertyPad() { return getAs("hasqwertypad", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the name of the company that manufactures the device or primarily sells it, e.g. Samsung.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHardwareVendor() { return getAs("hardwarevendor", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHardwareModel() { return getAs("hardwaremodel", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the common marketing names associated with the device, e.g. Xperia Z5.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareName() { return getAs("hardwarename", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the device is primarily a game console, such as an Xbox or Playstation.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsConsole() { return getAs("isconsole", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the name of the company that developed the operating system.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformVendor() { return getAs("platformvendor", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the name of the operating system the device is using.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformName() { return getAs("platformname", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the version or subversion of the software platform.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformVersion() { return getAs("platformversion", AspectPropertyValue.class, String.class.class); }
	/**
	 * Refers to the name of the embedded technology the browser uses to display formatted content on the screen.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getLayoutEngine() { return getAs("layoutengine", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the name of the company which created the browser.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserVendor() { return getAs("browservendor", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserName() { return getAs("browsername", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenMMWidth() { return getAs("screenmmwidth", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenMMHeight() { return getAs("screenmmheight", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBitsPerPixel() { return getAs("bitsperpixel", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the version or subversion of the browser.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserVersion() { return getAs("browserversion", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the official name of the CPU within the SoC, e.g. ARM Cortex A9 or Krait (Qualcomm).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getCPU() { return getAs("cpu", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getCcppAccept() { return getAs("ccppaccept", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Refers to the latest version of HyperText Markup Language (HTML) supported by the browser.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getHtmlVersion() { return getAs("htmlversion", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates if the browser supports JavaScript.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascript() { return getAs("javascript", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getJavascriptVersion() { return getAs("javascriptversion", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedBearers() { return getAs("supportedbearers", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSupportedBluetoothVersion() { return getAs("supportedbluetoothversion", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the maximum frequency of the CPU of the device in gigahertz (GHz).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getCPUMaximumFrequency() { return getAs("cpumaximumfrequency", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getReleaseYear() { return getAs("releaseyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getReleaseMonth() { return getAs("releasemonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCookiesCapable() { return getAs("cookiescapable", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getStreamingAccept() { return getAs("streamingaccept", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the device has a virtual qwerty keyboard capability.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasVirtualQwerty() { return getAs("hasvirtualqwerty", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a physical numeric keypad.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasKeypad() { return getAs("haskeypad", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a camera.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasCamera() { return getAs("hascamera", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getBackCameraMegaPixels() { return getAs("backcameramegapixels", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates the expansion slot type the device can support.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getExpansionSlotType() { return getAs("expansionslottype", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the maximum amount of memory in gigabytes (GB) the expansion slot of the device can support.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getExpansionSlotMaxSize() { return getAs("expansionslotmaxsize", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getDeviceRAM() { return getAs("deviceram", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getMaxInternalStorage() { return getAs("maxinternalstorage", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSuggestedImageButtonHeightPixels() { return getAs("suggestedimagebuttonheightpixels", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSuggestedImageButtonHeightMms() { return getAs("suggestedimagebuttonheightmms", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSuggestedLinkSizePixels() { return getAs("suggestedlinksizepixels", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSuggestedLinkSizePoints() { return getAs("suggestedlinksizepoints", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasTrackPad() { return getAs("hastrackpad", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a click wheel such as found on Apple iPod devices.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasClickWheel() { return getAs("hasclickwheel", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsEReader() { return getAs("isereader", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the JavaScript that can manipulate the Document Object Model on the browser's web page.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptCanManipulateDOM() { return getAs("javascriptcanmanipulatedom", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the JavaScript that can manipulate CSS on the browser's web page.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptCanManipulateCSS() { return getAs("javascriptcanmanipulatecss", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser allows registration of event listeners on event targets by using the addEventListener() method.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptSupportsEventListener() { return getAs("javascriptsupportseventlistener", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the JavaScript events 'onload', 'onclick' and 'onselect'. 
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptSupportsEvents() { return getAs("javascriptsupportsevents", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptGetElementById() { return getAs("javascriptgetelementbyid", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates what ajax request format should be used.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getAjaxRequestType() { return getAs("ajaxrequesttype", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates if the browser supports the JavaScript that is able to insert HTML into a DIV tag.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJavascriptSupportsInnerHtml() { return getAs("javascriptsupportsinnerhtml", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getJavascriptPreferredGeoLocApi() { return getAs("javascriptpreferredgeolocapi", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenMMDiagonal() { return getAs("screenmmdiagonal", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Lists what video formats, if any, the browser supports using the HTLM5 <video> tag.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHtml5Video() { return getAs("html5video", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Lists what audio formats, if any, the browser supports using the HTML5 <audio> tag.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHtml5Audio() { return getAs("html5audio", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the browser supports CSS3 columns for setting column- width and column-count.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssColumn() { return getAs("csscolumn", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports CSS3 transitions elements, used for animating changes to properties.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssTransitions() { return getAs("csstransitions", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a camera capable of taking 3D images.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHas3DCamera() { return getAs("has3dcamera", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the device has a screen capable of displaying 3D images.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHas3DScreen() { return getAs("has3dscreen", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsCrawler() { return getAs("iscrawler", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the crawler name when applicable. Returns NotCrawler when the device is not a crawler.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getCrawlerName() { return getAs("crawlername", AspectPropertyValue.class, String.class.class); }
	/**
	 * Refers to the grade of the level the device has with the jQuery Mobile Framework, as posted by jQuery.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getjQueryMobileSupport() { return getAs("jquerymobilesupport", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getCameraTypes() { return getAs("cameratypes", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the number of physical CPU cores the device has.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getCPUCores() { return getAs("cpucores", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates if the browser supports 'window.requestAnimationFrame()' method.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getAnimationTiming() { return getAs("animationtiming", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getBlobBuilder() { return getAs("blobbuilder", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssBackground() { return getAs("cssbackground", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports border images, allowing decoration of the border around an object.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssBorderImage() { return getAs("cssborderimage", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser can draw CSS images into a Canvas.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssCanvas() { return getAs("csscanvas", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports CSS3 Color, allowing author control of the foreground colour and opacity of an element.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssColor() { return getAs("csscolor", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssFlexbox() { return getAs("cssflexbox", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports CSS3 fonts, including non-standard fonts, e.g. @font-face.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssFont() { return getAs("cssfont", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports CSS3 images, allowing for fall-back images, gradients and other effects.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssImages() { return getAs("cssimages", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports MediaQueries for dynamic CSS that uses the @media rule.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssMediaQueries() { return getAs("cssmediaqueries", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the CSS 'min-width' and 'max-width' element.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssMinMax() { return getAs("cssminmax", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports overflowing of clipped blocks.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssOverflow() { return getAs("cssoverflow", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssPosition() { return getAs("cssposition", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports all CSS3 text features including: text-overflow, word-wrap and word-break.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssText() { return getAs("csstext", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssTransforms() { return getAs("csstransforms", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports CSS UI stylings, including text-overflow, css3-boxsizing and pointer properties.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssUI() { return getAs("cssui", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser has the ability to embed custom data attributes on all HTML elements using the 'data-' prefix.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getDataSet() { return getAs("dataset", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser allows encoded data to be contained in a URL.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getDataUrl() { return getAs("dataurl", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getDeviceOrientation() { return getAs("deviceorientation", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports file reading with events to show progress and errors.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFileReader() { return getAs("filereader", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFileSaver() { return getAs("filesaver", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFileWriter() { return getAs("filewriter", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFormData() { return getAs("formdata", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports requests from a video or canvas element to be displayed in full-screen mode.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFullscreen() { return getAs("fullscreen", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getGeoLocation() { return getAs("geolocation", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser stores the session history for a web page that contains the URLs visited by the browser's user.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHistory() { return getAs("history", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHtmlMediaCapture() { return getAs("html-media-capture", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHtml5() { return getAs("html5", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the 'Iframe' element, used to embed another document within a current HTML document.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIframe() { return getAs("iframe", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports an indexed local database.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIndexedDB() { return getAs("indexeddb", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the 'JSON' object. This property may need a vendor prefix, e.g. webkit, moz, etc.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJson() { return getAs("json", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports messages between different documents.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getPostMessage() { return getAs("postmessage", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getProgress() { return getAs("progress", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports simple dialogues (window.alert, window.confirm and window.prompt).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getPrompts() { return getAs("prompts", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSelector() { return getAs("selector", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSvg() { return getAs("svg", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getTouchEvents() { return getAs("touchevents", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports a method of tracking text being played with media, e.g. subtitles and captions.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getTrack() { return getAs("track", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the 'Video' element for playing videos on web pages without requiring a plug-in.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getVideo() { return getAs("video", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getViewport() { return getAs("viewport", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports background workers in JavaScript.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getWebWorkers() { return getAs("webworkers", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getXhr2() { return getAs("xhr2", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getMasking() { return getAs("masking", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the canvas element, useful for drawing graphics via scripting (usually JavaScript).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCanvas() { return getAs("canvas", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports TLS or SSL, essential for secure protocols such as HTTPS.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSupportsTlsSsl() { return getAs("supportstls/ssl", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates which version of the Connected Limited Device Configuration the device supports for use with Java ME.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getCLDC() { return getAs("cldc", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates which version of Mobile Information Device Profile the device supports, used with Java ME and CLDC.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getMIDP() { return getAs("midp", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenInchesDiagonal() { return getAs("screeninchesdiagonal", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates if the device is a TV running on a smart operating system e.g. Android.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsTv() { return getAs("istv", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenInchesHeight() { return getAs("screeninchesheight", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getScreenInchesWidth() { return getAs("screenincheswidth", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsSmartPhone() { return getAs("issmartphone", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsSmallScreen() { return getAs("issmallscreen", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareImages() { return getAs("hardwareimages", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the device has embedded NFC (Near Field Communication) wireless technology.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasNFC() { return getAs("hasnfc", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHardwareFamily() { return getAs("hardwarefamily", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsEmailBrowser() { return getAs("isemailbrowser", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the name of the company that manufactures the device.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getOEM() { return getAs("oem", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedChargerTypes() { return getAs("supportedchargertypes", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHasRemovableBattery() { return getAs("hasremovablebattery", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBatteryCapacity() { return getAs("batterycapacity", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates  the device's supported satellite navigation types.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSatelliteNavigationTypes() { return getAs("satellitenavigationtypes", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedSensorTypes() { return getAs("supportedsensortypes", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the device's Ingress Protection Rating against dust and water (http://en.wikipedia.org/wiki/IP_Code).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getDurability() { return getAs("durability", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getMaxNumberOfSIMCards() { return getAs("maxnumberofsimcards", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedSIMCardTypes() { return getAs("supportedsimcardtypes", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the official name of the graphical chip within the SoC.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getGPU() { return getAs("gpu", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the list of features the device's camera supports.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedCameraFeatures() { return getAs("supportedcamerafeatures", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getMaxTalkTime() { return getAs("maxtalktime", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the maximum standby time of the device in hours. This property is not applicable for a device without a battery.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getMaxStandbyTime() { return getAs("maxstandbytime", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the dynamic contrast ratio of the device's screen.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getDynamicContrastRatio() { return getAs("dynamiccontrastratio", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates if the device supports Wireless Display Technology.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSupportsWiDi() { return getAs("supportswidi", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the annual energy consumption of the device per year in kWh.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getEnergyConsumptionPerYear() { return getAs("energyconsumptionperyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates if the device supports 24p; a video format that operates at 24 frames per second.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSupports24p() { return getAs("supports24p", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the list of input and output communications the device can support, for example 3.5mm jack, micro-USB etc.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedIO() { return getAs("supportedi/o", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the maximum number of frames per second of the output image of the device in Hertz.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getRefreshRate() { return getAs("refreshrate", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getScreenType() { return getAs("screentype", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the power consumption of the device while switched on.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getOnPowerConsumption() { return getAs("onpowerconsumption", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the contrast ratio of the device.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getContrastRatio() { return getAs("contrastratio", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getMaxUsageTime() { return getAs("maxusagetime", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the Semiconductor Company that designed the CPU.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getCPUDesigner() { return getAs("cpudesigner", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the Semiconductor Company that designed the GPU.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getGPUDesigner() { return getAs("gpudesigner", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getFrontCameraMegaPixels() { return getAs("frontcameramegapixels", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSoC() { return getAs("soc", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the Semiconductor Company that designed the System on Chip (chipset) e.g. Qualcomm, Intel or Mediatek.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSoCDesigner() { return getAs("socdesigner", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the official model of the System on Chip (chipset) e.g. MSM8625, MT8312.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSoCModel() { return getAs("socmodel", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates if the device is a media hub or set top box that requires an external display(s).
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsMediaHub() { return getAs("ismediahub", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getJavascriptHardwareProfile() { return getAs("javascripthardwareprofile", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * Refers to the JavaScript snippet used to optimise images.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getJavascriptImageOptimiser() { return getAs("javascriptimageoptimiser", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getBrowserAudioCodecsDecode() { return getAs("browseraudiocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getBrowserVideoCodecsDecode() { return getAs("browservideocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPriceBand() { return getAs("priceband", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenMMSquare() { return getAs("screenmmsquare", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenMMDiagonalRounded() { return getAs("screenmmdiagonalrounded", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenInchesSquare() { return getAs("screeninchessquare", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenInchesDiagonalRounded() { return getAs("screeninchesdiagonalrounded", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getDeviceType() { return getAs("devicetype", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserPropertySource() { return getAs("browserpropertysource", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates if the browser supports WebGL technology to generate hardware-accelerated 3D graphics.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSupportsWebGL() { return getAs("supportswebgl", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsEmulatingDesktop() { return getAs("isemulatingdesktop", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getSupportsPhoneCalls() { return getAs("supportsphonecalls", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsWebApp() { return getAs("iswebapp", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getMeter() { return getAs("meter", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsSmartWatch() { return getAs("issmartwatch", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getNativePlatform() { return getAs("nativeplatform", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getNativeBrand() { return getAs("nativebrand", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getNativeDevice() { return getAs("nativedevice", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getNativeModel() { return getAs("nativemodel", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getNativeName() { return getAs("nativename", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getScreenPixelsHeightJavaScript() { return getAs("screenpixelsheightjavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getScreenPixelsWidthJavaScript() { return getAs("screenpixelswidthjavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * Indicates what certifications apply to this device.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getDeviceCertifications() { return getAs("devicecertifications", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the resolution of the device's second back camera in megapixels.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondBackCameraMegaPixels() { return getAs("secondbackcameramegapixels", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareAudioCodecsDecode() { return getAs("hardwareaudiocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareVideoCodecsDecode() { return getAs("hardwarevideocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSoftwareAudioCodecsDecode() { return getAs("softwareaudiocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSoftwareAudioCodecsEncode() { return getAs("softwareaudiocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSoftwareVideoCodecsDecode() { return getAs("softwarevideocodecsdecode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSoftwareVideoCodecsEncode() { return getAs("softwarevideocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformReleaseYear() { return getAs("platformreleaseyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformReleaseMonth() { return getAs("platformreleasemonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformPreviewMonth() { return getAs("platformpreviewmonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformPreviewYear() { return getAs("platformpreviewyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPlatformDiscontinuedMonth() { return getAs("platformdiscontinuedmonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformDiscontinuedYear() { return getAs("platformdiscontinuedyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserPreviewMonth() { return getAs("browserpreviewmonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserPreviewYear() { return getAs("browserpreviewyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserReleaseMonth() { return getAs("browserreleasemonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserReleaseYear() { return getAs("browserreleaseyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserDiscontinuedMonth() { return getAs("browserdiscontinuedmonth", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserDiscontinuedYear() { return getAs("browserdiscontinuedyear", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareAudioCodecsEncode() { return getAs("hardwareaudiocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareVideoCodecsEncode() { return getAs("hardwarevideocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates a browser that does not correctly identify the physical hardware device and instead reports an emulated device.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsEmulatingDevice() { return getAs("isemulatingdevice", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsDataMinimising() { return getAs("isdataminimising", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the resolution of the device's second front camera in megapixels.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondFrontCameraMegaPixels() { return getAs("secondfrontcameramegapixels", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getBrowserAudioCodecsEncode() { return getAs("browseraudiocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getBrowserVideoCodecsEncode() { return getAs("browservideocodecsencode", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSpecificAbsorbtionRateUS() { return getAs("specificabsorbtionrateus", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSpecificAbsorbtionRateEU() { return getAs("specificabsorbtionrateeu", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates the weight of the device with battery in grams.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getWeightWithBattery() { return getAs("weightwithbattery", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates the weight of the device without battery in grams.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getWeightWithoutBattery() { return getAs("weightwithoutbattery", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates if the browser supports HTTP Live Streaming, also known as HLS.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHttpLiveStreaming() { return getAs("httplivestreaming", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getHardwareModelVariants() { return getAs("hardwaremodelvariants", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHardwareCarrier() { return getAs("hardwarecarrier", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getHardwareRank() { return getAs("hardwarerank", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformRank() { return getAs("platformrank", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the operating system since the PlatformPreviewYear and PlatformPreviewMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformPreviewAge() { return getAs("platformpreviewage", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the operating system since the PlatformReleaseYear and PlatformReleaseMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformReleaseAge() { return getAs("platformreleaseage", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the operating system since the PlatformReleaseYear and PlatformReleaseMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getPlatformDiscontinuedAge() { return getAs("platformdiscontinuedage", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserRank() { return getAs("browserrank", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the browser since the BrowserPreviewYear and BrowserPreviewMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserPreviewAge() { return getAs("browserpreviewage", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the browser since the BrowserReleaseYear and BrowserReleaseMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserReleaseAge() { return getAs("browserreleaseage", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the browser since the BrowserDiscontinuedYear and BrowserDiscontinuedMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getBrowserDiscontinuedAge() { return getAs("browserdiscontinuedage", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the age in months of the device since the ReleaseYear and ReleaseMonth.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getReleaseAge() { return getAs("releaseage", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsHardwareGroup() { return getAs("ishardwaregroup", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getInternalStorageVariants() { return getAs("internalstoragevariants", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getPromise() { return getAs("promise", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getHardwareProfileSource() { return getAs("hardwareprofilesource", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getDeviceRAMVariants() { return getAs("deviceramvariants", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates the list of frequency bands supported by the device.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getFrequencyBands() { return getAs("frequencybands", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if a web page is accessed through a VR headset.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getInVRMode() { return getAs("invrmode", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getIsScreenFoldable() { return getAs("isscreenfoldable", AspectPropertyValue.class, Boolean.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenInchesDiagonal() { return getAs("secondscreeninchesdiagonal", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenInchesWidth() { return getAs("secondscreenincheswidth", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenPixelsWidth() { return getAs("secondscreenpixelswidth", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenInchesDiagonalRounded() { return getAs("secondscreeninchesdiagonalrounded", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenInchesSquare() { return getAs("secondscreeninchessquare", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenInchesHeight() { return getAs("secondscreeninchesheight", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenMMDiagonal() { return getAs("secondscreenmmdiagonal", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenMMDiagonalRounded() { return getAs("secondscreenmmdiagonalrounded", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenMMHeight() { return getAs("secondscreenmmheight", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenMMSquare() { return getAs("secondscreenmmsquare", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSecondScreenMMWidth() { return getAs("secondscreenmmwidth", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getSecondScreenPixelsHeight() { return getAs("secondscreenpixelsheight", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getTAC() { return getAs("tac", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the browser supports all CSS grid properties.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getCssGrid() { return getAs("cssgrid", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the Fetch API.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getFetch() { return getAs("fetch", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser supports the WebP image format.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getWebP() { return getAs("webp", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the number of screens the device has. This property is not applicable for a device that does not have a screen.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getNumberOfScreens() { return getAs("numberofscreens", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates if the browser supports HTTP version 2.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getHttp2() { return getAs("http2", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates if the browser can prefetch resources without executing them.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getPreload() { return getAs("preload", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the browser supports JPEG 2000 image format.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Boolean> getJpeg2000() { return getAs("jpeg2000", AspectPropertyValue.class, Boolean.class.class); }
	/**
	 * Indicates the name of the browser without the default OS or layout engine.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserFamily() { return getAs("browserfamily", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getPixelRatio() { return getAs("pixelratio", AspectPropertyValue.class, Double.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getPixelRatioJavascript() { return getAs("pixelratiojavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSetHeaderBrowserAcceptCH() { return getAs("setheaderbrowseraccept-ch", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSetHeaderHardwareAcceptCH() { return getAs("setheaderhardwareaccept-ch", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSetHeaderPlatformAcceptCH() { return getAs("setheaderplatformaccept-ch", AspectPropertyValue.class, String.class.class); }
	/**
	 * Contains Javascript to get high entropy values.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getJavascriptGetHighEntropyValues() { return getAs("javascriptgethighentropyvalues", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * JavaScript that checks for browser specific features and overrides the ProfileID.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getJavaScriptBrowserOverride() { return getAs("javascriptbrowseroverride", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * Name of the underlying browser source project.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserSourceProject() { return getAs("browsersourceproject", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the version or subversion of the underlying browser source project.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserSourceProjectVersion() { return getAs("browsersourceprojectversion", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getTopicsAPIEnabled() { return getAs("topicsapienabled", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getSharedStorageAPIEnabled() { return getAs("sharedstorageapienabled", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getProtectedAudienceAPIEnabled() { return getAs("protectedaudienceapienabled", AspectPropertyValue.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getBrowserLogos() { return getAs("browserlogos", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getPlatformLogos() { return getAs("platformlogos", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates if the browser supports the experimental Privacy Sandbox API proposals from Google.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getBrowserSupportsPrivacySandbox() { return getAs("browsersupportsprivacysandbox", AspectPropertyValue.class, String.class.class); }
	/**
	 * JavaScript that overrides the property value for the TopicsAPIEnabled property.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getTopicsAPIEnabledJavaScript() { return getAs("topicsapienabledjavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * JavaScript that overrides the property value for the SharedStorageAPIEnabled property.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getSharedStorageAPIEnabledJavaScript() { return getAs("sharedstorageapienabledjavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	 * JavaScript that overrides the property value for the ProtectedAudienceAPIEnabled property.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<JavaScript> getProtectedAudienceAPIEnabledJavaScript() { return getAs("protectedaudienceapienabledjavascript", AspectPropertyValue.class, JavaScript.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenPixelsPhysicalHeight() { return getAs("screenpixelsphysicalheight", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getScreenPixelsPhysicalWidth() { return getAs("screenpixelsphysicalwidth", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Indicates the highest version of Bluetooth the device supports.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Double> getSupportedBluetooth() { return getAs("supportedbluetooth", AspectPropertyValue.class, Double.class.class); }
	/**
	 * Indicates the Bluetooth profiles the device supports.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getSupportedBluetoothProfiles() { return getAs("supportedbluetoothprofiles", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	 * Indicates whether the crawler is confirmed by the crawler controller to be used to train artificial intelligence.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getIsArtificialIntelligence() { return getAs("isartificialintelligence", AspectPropertyValue.class, String.class.class); }
	/**
	 * Indicates the number of hash nodes matched within the evidence.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getMatchedNodes() { return getAs("matchednodes", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getDifference() { return getAs("difference", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * Total difference in character positions where the substrings hashes were found away from where they were expected.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getDrift() { return getAs("drift", AspectPropertyValue.class, Integer.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getDeviceId() { return getAs("deviceid", AspectPropertyValue.class, String.class.class); }
	/**
	 * The matched User-Agents.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<List<String>> getUserAgents() { return getAs("useragents", AspectPropertyValue.class, List.class, String.class.class); }
	/**
	...
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<Integer> getIterations() { return getAs("iterations", AspectPropertyValue.class, Integer.class.class); }
	/**
	 * The method used to determine the match result.
	 */
	@SuppressWarnings("unchecked")
	@Override
	public AspectPropertyValue<String> getMethod() { return getAs("method", AspectPropertyValue.class, String.class.class); }
}
