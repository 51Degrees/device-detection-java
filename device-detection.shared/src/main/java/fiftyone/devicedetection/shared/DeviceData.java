...
{
    /**
     * Device Id uniquely identifying the device.
     */
    ...
    /**
     * The matched User-Agent strings showing the matched and unmatched
     * characters. This is only available if the update matched User-Agent
     * option was set to true in the builder.
     */
     ...
     */
    AspectPropertyValue<String> getSecondBackCameraMegaPixels();
    /**
     * Indicates the resolution of the device's second front camera in megapixels.
     */
    AspectPropertyValue<String> getSecondFrontCameraMegaPixels();
    /**
     ...
     */
    AspectPropertyValue<String> getSpecificAbsorbtionRateEU();
    /**
     ...
     */
    AspectPropertyValue<Integer> getSpecificAbsorbtionRateUS();
    /**
     ...
     */
    AspectPropertyValue<String> getWeightWithBattery();
    /**
     * Indicates the weight of the device without battery in grams.
     */
    AspectPropertyValue<String> getWeightWithoutBattery();
    /**
     ...
     */
    AspectPropertyValue<String> getPlatformDiscontinuedYear();
    /**
     ...
     */
    AspectPropertyValue<String> getPlatformPreviewYear();
    /**
     ...
     */
    AspectPropertyValue<String> getPlatformReleaseYear();
    /**
     ...
     */
    AspectPropertyValue<String> getBrowserDiscontinuedYear();
    /**
     ...
     */
    AspectPropertyValue<String> getBrowserPreviewYear();
    /**
     ...
     */
    AspectPropertyValue<String> getInVRMode();
    /**
     ...
     */
    AspectPropertyValue<String> getIsEmulatingDesktop();
    /**
     ...
     */
    AspectPropertyValue<String> getIsWebApp();
    /**
     ...
     */
    AspectPropertyValue<String> getJavascriptImageOptimiser();
    /**
