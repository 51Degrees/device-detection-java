...
import fiftyone.devicedetection.pattern.engine.onpremise.data.ComponentMetaDataPattern;
import fiftyone.devicedetection.pattern.engine.onpremise.flowelements.DeviceDetectionPatternEngine;
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.ComponentMetaDataCollectionSwig;
...
public class ComponentIterable
    ...
    protected ComponentMetaData get(long index) {
        return new ComponentMetaDataPattern(engine, collection.getByIndex(index));
    }
