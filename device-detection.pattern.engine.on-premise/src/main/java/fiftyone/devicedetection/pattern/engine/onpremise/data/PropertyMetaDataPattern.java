...
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.ValueMetaDataKeySwig;
...
public class PropertyMetaDataPattern implements FiftyOneAspectPropertyMetaData {
    ...
    public PropertyMetaDataPattern(
    ...
    public ValueMetaData getDefaultValue() {
        ...
        return value == null ?
            null :
            new ValueMetaDataPattern(engine, value);
    }
