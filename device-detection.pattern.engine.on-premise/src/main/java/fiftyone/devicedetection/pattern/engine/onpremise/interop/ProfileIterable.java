...
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.ProfileMetaDataCollectionSwig;
...
public class ProfileIterable
    ...
    protected ProfileMetaData get(long index) {
        return new ProfileMetaDataPattern(engine, collection.getByIndex(index));
    }
