...
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.ComponentMetaDataSwig;
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.PropertyMetaDataCollectionSwig;
import fiftyone.devicedetection.pattern.engine.onpremise.interop.swig.PropertyMetaDataSwig;
...
public class ComponentMetaDataPattern implements ComponentMetaData {
    ...
    public ComponentMetaDataPattern(
    ...
    public FiftyOneAspectPropertyMetaData getProperty(String propertyName) {
        ...
        if (value != null) {
            result = new PropertyMetaDataPattern(engine, value);
        }
        components.delete();
        return result;
    }
