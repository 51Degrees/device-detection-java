...
public class ValuePatternTests extends TestsBase {
    ...
    @Test
    public void Values_Pattern_ValueTypes() throws Exception {
        ValueTests.valueTypes(getWrapper());
    }

    @Test
    public void Values_Pattern_AvailableProperties() throws Exception {
        ValueTests.availableProperties(getWrapper());
    }

    @Test
    public void Values_Pattern_TypedGetters() throws Exception {
        ValueTests.typedGetters(getWrapper());
    }

    @Test
    public void Values_Pattern_DeviceId() throws Exception {
        ValueTests.deviceId(getWrapper());
    }

    @Test
    public void Values_Pattern_MatchedUserAgents() throws Exception {
