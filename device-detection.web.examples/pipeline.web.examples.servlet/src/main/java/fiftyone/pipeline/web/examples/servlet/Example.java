...
public class Example extends HttpServlet {
    ...
    public static void main(String[] args) throws LifecycleException {
        EmbedTomcat.runWebApp("device-detection.web.examples/pipeline.web.examples.servlet/src/main/webapp",
                "device-detection.web.examples/pipeline.web.examples.servlet/target",
                8081);
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<script src=\"51Degrees.core.js\"></script>");
